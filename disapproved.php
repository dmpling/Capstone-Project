...
$stmt->bind_param('s', $_SESSION['disapproved_appointment_id']);
$stmt->execute();
...
<div class="container">
		<h2> <i class="fa-regular fa-face-frown"></i> | Disapprove Online Document Request: </h2>
...
<form class="custom-form" action="send_disapproved.php" method="post">
    <label> Email: </label>
    <input type="email" name="email" value="<?=$email?>"> <br>
    <label> Subject: </label>
    <input type="text" name="subject" value="LNCHS-RMS iGetDocuments"> <br>
    <label> Reasons: (click send if none) </label>
    ...
    <input type="hidden" name="received_date" value="Disapproved"/>
